  ...
  return (
    <div className="Blogs__page">
      ...
      <p className="Blogs__content">
        ...
        businesses, which are shaped according to his/her vision.
      </p>
      <h3 className="Blogs__subTitle">An entrepreneur is seen as the entity</h3>
      <p className="Blogs__content">
        who transforms an invention or a technology into products and services
        which serve the masses and results in a substantial profit for the
        economy. Entrepreneurs are seen as innovators, sources of new ideas, and
        handlers of multiple businesses.
      </p>
      <p className="Blogs__quote">
